    ...
    void Update()
    {
        ...
        if (gameManager.gameStarted == true && gameManager.gameOver == false)
        {
            ...
            if (gameManager.altControlSlider.value == 1)    // if alternate control scheme is in use
            {
                ...
                if (ControlFreak2.CF2Input.GetKey(KeyCode.S) && gameManager.fuel > 0)    // controls down movement when alt controls in use
                {
                    playerRb.constraints &= ~RigidbodyConstraints.FreezePositionY;
                ...
                if (ControlFreak2.CF2Input.GetKey(KeyCode.D) && gameManager.fuel > 0)    // controls down movement when alt controls in use
                {
                ...
                if (ControlFreak2.CF2Input.GetKey(KeyCode.A) && gameManager.fuel > 0)    // controls down movement when alt controls in use
                {
                    playerRb.constraints &= ~RigidbodyConstraints.FreezePositionX;
            ...
            if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.W) && gameManager.fuel > 0) 
            {
            ...
            {
                if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.S) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.D) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.A))
                {
                    playerAudio.PlayOneShot(boostSound);
                }
            }
            ...
            if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.LeftControl))
            {
                doubleSpeed = true;
                fastFuelDrain = true;
            }
            ...
            if (ControlFreak2.CF2Input.GetKeyUp(KeyCode.LeftControl))
            {
                doubleSpeed = false;
                fastFuelDrain = false;
            }
            ...
            if (gameManager.gameStarted == true && gameManager.gameOver == false && hasPowerup == true && ControlFreak2.CF2Input.GetKeyDown(KeyCode.Space))
